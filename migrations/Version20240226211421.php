...
final class Version20240226211421 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user_phone ADD CONSTRAINT FK_user_phone_user_id FOREIGN KEY (user_id) REFERENCES users (id)');
