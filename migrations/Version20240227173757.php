...
final class Version20240227173757 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE friends ADD CONSTRAINT FK_friends_user_id FOREIGN KEY (user_id) REFERENCES users (id)');
        $this->addSql('ALTER TABLE friends ADD CONSTRAINT FK_friends_friend_user_id FOREIGN KEY (friend_user_id) REFERENCES users (id)');
    }
